...
| [drawio-diagram-creation](../skills/drawio-diagram-creation/SKILL.md) | Create professional diagrams using draw.io MCP server. Generates flowcharts, architecture diagrams, org charts, UML diagrams, and more using XML, CSV, or Mermaid.js formats. Includes Azure-specific icon libraries and Microsoft architecture best practices. | `assets/example-azure-hub-spoke.md`<br />`assets/example-cicd-pipeline.md`<br />`assets/example-org-chart.md` |
